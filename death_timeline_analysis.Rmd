...
```
<p><strong>Data for November 2020 is not yet complete!!!!!11oneoneeleven. Using an odokatif extrapolation, I expect for the final count to increase by about 600.</strong></p>
```{r echo = FALSE}
downloadLink(
